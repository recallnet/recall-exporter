...
//
// Solidity: function bottomUpCheckpoint(uint256 e) view returns(((uint64,address[]),uint256,bytes32,uint64,(uint8,((uint64,address[]),(uint8,bytes)),((uint64,address[]),(uint8,bytes)),uint64,uint256,bytes)[]))
...
//
// Solidity: function getCheckpointSignatureBundle(uint256 h) view returns(((uint64,address[]),uint256,bytes32,uint64,(uint8,((uint64,address[]),(uint8,bytes)),((uint64,address[]),(uint8,bytes)),uint64,uint256,bytes)[]) ch, (bytes32,bytes32,uint256,uint256,bool) info, address[] signatories, bytes[] signatures)
...
//
// Solidity: function getCurrentBottomUpCheckpoint() view returns(bool exists, uint256 epoch, ((uint64,address[]),uint256,bytes32,uint64,(uint8,((uint64,address[]),(uint8,bytes)),((uint64,address[]),(uint8,bytes)),uint64,uint256,bytes)[]) checkpoint)
...
//
// Solidity: function getIncompleteCheckpoints() view returns(((uint64,address[]),uint256,bytes32,uint64,(uint8,((uint64,address[]),(uint8,bytes)),((uint64,address[]),(uint8,bytes)),uint64,uint256,bytes)[])[])
