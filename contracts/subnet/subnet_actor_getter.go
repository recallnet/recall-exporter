...
//
// Solidity: function bottomUpCheckpointAtEpoch(uint256 epoch) view returns(bool exists, ((uint64,address[]),uint256,bytes32,uint64,(uint8,((uint64,address[]),(uint8,bytes)),((uint64,address[]),(uint8,bytes)),uint64,uint256,bytes)[],(((uint64,uint64),bytes32))) checkpoint)
...
func (_Subnet *SubnetCaller) GetActiveValidators(opts *bind.CallOpts) ([]common.Address, error) {
	var out []interface{}
	err := _Subnet.contract.Call(opts, &out, "getActiveValidators")
...
//
// Solidity: function getActiveValidators() view returns(address[])
func (_Subnet *SubnetSession) GetActiveValidators() ([]common.Address, error) {
	return _Subnet.Contract.GetActiveValidators(&_Subnet.CallOpts)
}

// GetActiveValidators is a free data retrieval call binding the contract method 0x9de70258.
//
// Solidity: function getActiveValidators() view returns(address[])
func (_Subnet *SubnetCallerSession) GetActiveValidators() ([]common.Address, error) {
	return _Subnet.Contract.GetActiveValidators(&_Subnet.CallOpts)
}
...
// GetWaitingValidators is a free data retrieval call binding the contract method 0x6ad04c79.
//
// Solidity: function getWaitingValidators() view returns(address[])
func (_Subnet *SubnetCaller) GetWaitingValidators(opts *bind.CallOpts) ([]common.Address, error) {
	var out []interface{}
	err := _Subnet.contract.Call(opts, &out, "getWaitingValidators")
...
//
// Solidity: function getWaitingValidators() view returns(address[])
func (_Subnet *SubnetSession) GetWaitingValidators() ([]common.Address, error) {
	return _Subnet.Contract.GetWaitingValidators(&_Subnet.CallOpts)
}

// GetWaitingValidators is a free data retrieval call binding the contract method 0x6ad04c79.
//
// Solidity: function getWaitingValidators() view returns(address[])
func (_Subnet *SubnetCallerSession) GetWaitingValidators() ([]common.Address, error) {
	return _Subnet.Contract.GetWaitingValidators(&_Subnet.CallOpts)
}
